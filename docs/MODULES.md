...
| `signal_radar` | email, username, phone, full_name, ip_address, domain, url, asn, cidr, coordinates, address, organisation, abn_acn, mac_address, api_key, crypto_address | free | **yes** | 60 | mac_address, ip_address, coordinates, device_id |
