...
- 65 correlator rules (AU-001 through AU-064 plus AU-067), incl. graph-aware edge, transitive, multi-pathway corroboration, gap-analysis, pathway-template, and resolved-identity-cluster rules (plus engine-emitted cross-scan findings AU-065/AU-066)
