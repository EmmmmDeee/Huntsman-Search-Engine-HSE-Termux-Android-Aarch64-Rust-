...
Pure-Rust OSINT / GEOINT platform with **92 modules** that runs entirely
...
## Module Overview (93 modules — 70 free, 23 key-gated/paid)
...
- 38 correlator rules (AU-001 through AU-038), incl. 2 graph-aware edge rules
