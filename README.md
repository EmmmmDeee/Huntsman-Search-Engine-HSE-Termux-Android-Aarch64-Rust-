...
Pure-Rust OSINT / GEOINT platform with **102 modules** that runs entirely
...
hse modules                                                 # list all 102 modules
...
## Module Overview (104 modules — 79 free, 25 key-gated/paid)
...
- **Social**: `github_user`, `hacker_news`, `reddit_user`, `keybase`, `social_probe`, `username_search`, `username_variants`
