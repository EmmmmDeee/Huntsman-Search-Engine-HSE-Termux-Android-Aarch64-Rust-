  ...
  v.innerHTML = `
    ...
    <h2>${esc(scan.target?.value||id)}
        ...
        <div class="pull-right">
          ...
          <a class="btn btn-default btn-sm" href="${API.stixUrl(id)}" data-download title="Export as a STIX 2.1 bundle (import into MISP / OpenCTI / TAXII / any STIX 2.1 consumer). Entities, typed relations, and correlation findings — ATT&CK-tagged, deterministic."><i class="glyphicon glyphicon-transfer"></i>&nbsp;STIX</a>
        ...
        <div class="text-muted" style="font-size:11px;margin-top:4px">
          ...
          <div style="margin-top:2px"><i class="glyphicon glyphicon-lock"></i>&nbsp;CSV / JSON / GEXF / STIX / Log downloads are <b>client-safe</b> — your breach-source providers are shown as “breach-source”, never named. Only the <span class="text-warning">Debug bundle (operator)</span> names them.</div>
        </div>
    </h2>
