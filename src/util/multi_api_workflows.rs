...
pub const ADVANCED_WORKFLOWS: &[AdvancedWorkflow] = &[
    ...
    AdvancedWorkflow {
        ...
        steps: &[
            WorkflowStep {
                ...
                uses_entity_from: None,
            },
            WorkflowStep {
                step_num: 2,
                operation: "infrastructure",
                api: "Shodan",
                depends_on_step: Some(1),
                uses_entity_from: Some("ip"),
            },
            WorkflowStep {
                step_num: 3,
            ...
            WorkflowStep {
                step_num: 4,
                operation: "threat_intel",
                api: "GreyNoise",
                depends_on_step: Some(3),
                uses_entity_from: Some("ip"),
            },
            WorkflowStep {
                step_num: 5,
            ...
            WorkflowStep {
                ...
                api: "Censys",
                depends_on_step: Some(5),
                uses_entity_from: Some("domain"),
            },
        ],
        estimated_cost: 600,
    ...
    AdvancedWorkflow {
        ...
        steps: &[
            ...
            WorkflowStep {
                step_num: 3,
                operation: "ip_enumeration",
                api: "Shodan",
                depends_on_step: Some(2),
                uses_entity_from: Some("ip"),
            },
            WorkflowStep {
                step_num: 4,
                operation: "certificate_search",
                api: "Censys",
                depends_on_step: Some(1),
                uses_entity_from: Some("domain"),
            },
    ...
    AdvancedWorkflow {
        ...
        steps: &[
            ...
            WorkflowStep {
                step_num: 5,
                operation: "deep_breach_search",
                api: "OathNet Pro",
                depends_on_step: Some(3),
                uses_entity_from: Some("password"),
            },
        ],
        estimated_cost: 500,
        estimated_time_secs: 120,
    ...
    AdvancedWorkflow {
        ...
        steps: &[
            ...
            WorkflowStep {
                step_num: 2,
                operation: "company_context",
                api: "Hunter.io",
                depends_on_step: Some(1),
                uses_entity_from: Some("email_domain"),
            },
            WorkflowStep {
                step_num: 3,
                operation: "password_breach",
                api: "HIBP",
                depends_on_step: Some(1),
                uses_entity_from: Some("email"),
            },
            WorkflowStep {
                step_num: 4,
                operation: "header_ip_reputation",
                api: "AbuseIPDB",
                depends_on_step: Some(1),
                uses_entity_from: Some("ip_from_header"),
            },
        ],
        estimated_cost: 300,
    ...
    AdvancedWorkflow {
        ...
        steps: &[
            ...
            WorkflowStep {
                ...
                api: "OathNet Pro",
                depends_on_step: Some(1),
                uses_entity_from: Some("api_key_patterns"),
            },
            WorkflowStep {
                step_num: 4,
                operation: "exposed_config_search",
                api: "Leakix",
                depends_on_step: Some(1),
                uses_entity_from: Some("domain"),
            },
    ...
    AdvancedWorkflow {
        ...
        steps: &[
            WorkflowStep {
                step_num: 1,
                operation: "vendor_breach_search",
                api: "SeekNow",
                depends_on_step: None,
                uses_entity_from: None,
            },
    ...
    AdvancedWorkflow {
        ...
        steps: &[
            WorkflowStep {
                step_num: 1,
                operation: "company_breach_search",
                api: "SeekNow",
                depends_on_step: None,
                uses_entity_from: None,
            },
            ...
            WorkflowStep {
                step_num: 3,
                operation: "credential_history",
                api: "OathNet Pro",
                depends_on_step: Some(2),
                uses_entity_from: Some("email_password_combo"),
            },
        ],
        estimated_cost: 400,
    ...
    AdvancedWorkflow {
        ...
        steps: &[
            WorkflowStep {
                step_num: 1,
                operation: "username_breach_search",
                api: "SeekNow",
                depends_on_step: None,
                uses_entity_from: None,
            },
            WorkflowStep {
                ...
                api: "Hunter.io",
                depends_on_step: Some(1),
                uses_entity_from: Some("email_from_breach"),
            },
            WorkflowStep {
                step_num: 3,
                operation: "password_leak_check",
                api: "HIBP",
                depends_on_step: Some(2),
                uses_entity_from: Some("email"),
            },
            ...
            WorkflowStep {
                ...
                api: "Shodan",
                depends_on_step: Some(1),
                uses_entity_from: Some("domain_from_breach"),
            },
            WorkflowStep {
                step_num: 6,
    ...
    AdvancedWorkflow {
        ...
        steps: &[
            ...
            WorkflowStep {
                step_num: 2,
                operation: "daily_email_scan",
                api: "OathNet Pro",
                depends_on_step: Some(1),
                uses_entity_from: Some("employee_emails"),
            },
            WorkflowStep {
                step_num: 3,
                operation: "exposed_data_check",
                api: "Leakix",
                depends_on_step: Some(1),
                uses_entity_from: Some("domain"),
            },
    ...
    AdvancedWorkflow {
        ...
        steps: &[
            WorkflowStep {
                step_num: 1,
                operation: "universal_breach_search",
                api: "SeekNow",
                depends_on_step: None,
                uses_entity_from: None,
            },
            WorkflowStep {
                step_num: 2,
                operation: "infrastructure_intelligence",
                api: "Shodan",
                depends_on_step: Some(1),
                uses_entity_from: Some("domain_ip"),
            },
            WorkflowStep {
                step_num: 3,
                operation: "dns_and_history",
                api: "SecurityTrails",
                depends_on_step: Some(1),
                uses_entity_from: Some("domain"),
            },
            WorkflowStep {
                step_num: 4,
                operation: "certificate_intelligence",
                api: "Censys",
                depends_on_step: Some(1),
                uses_entity_from: Some("domain"),
            },
            WorkflowStep {
                step_num: 5,
                operation: "employee_enumeration",
                api: "Hunter.io",
                depends_on_step: Some(1),
                uses_entity_from: Some("domain_email"),
            },
            WorkflowStep {
                step_num: 6,
                operation: "ip_reputation",
            ...
            WorkflowStep {
                step_num: 7,
                operation: "threat_intelligence",
                api: "GreyNoise",
                depends_on_step: Some(6),
                uses_entity_from: Some("ip"),
            },
            WorkflowStep {
                step_num: 8,
            ...
            WorkflowStep {
                ...
                api: "Leakix",
                depends_on_step: Some(1),
                uses_entity_from: Some("domain_config"),
            },
        ],
        estimated_cost: 2500,
...
pub const WORKFLOW_RECOMMENDATIONS: &[WorkflowRecommendation] = &[
    ...
    WorkflowRecommendation {
        target_type: "ip",
        recommended_workflows: &["complete_ip_investigation", "threat_actor_complete"],
        primary_workflow: "complete_ip_investigation",
    },
    WorkflowRecommendation {
        target_type: "username",
        recommended_workflows: &["threat_actor_complete", "complete_person_dossier"],
...
impl WorkflowExecutionContext {
    ...
    pub fn discover_entity(&mut self, entity: String, entity_type: String, source_api: String) {
        self.discovered_entities
            .push((entity, entity_type, source_api));
    }
}
