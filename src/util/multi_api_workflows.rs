...
pub const ADVANCED_WORKFLOWS: &[AdvancedWorkflow] = &[
    ...
    AdvancedWorkflow {
        ...
        apis_used: &["SeekNow", "Hunter.io", "HIBP", "FullContact", "OathNetPro"],
        steps: &[
            WorkflowStep { step_num: 1, operation: "breach_search", api: "SeekNow", depends_on_step: None, uses_entity_from: None },
            ...
            WorkflowStep { step_num: 5, operation: "deep_breach_search", api: "OathNetPro", depends_on_step: Some(3), uses_entity_from: Some("password") },
        ],
        estimated_cost: 500,
        estimated_time_secs: 120,
    ...
    AdvancedWorkflow {
        ...
        apis_used: &["SeekNow", "OathNetPro", "Leakix"],
        steps: &[
            ...
            WorkflowStep { step_num: 3, operation: "deep_breach_search", api: "OathNetPro", depends_on_step: Some(1), uses_entity_from: Some("api_key_patterns") },
    ...
    AdvancedWorkflow {
        ...
        apis_used: &["SeekNow", "HIBP", "OathNetPro"],
        steps: &[
            ...
            WorkflowStep { step_num: 3, operation: "credential_history", api: "OathNetPro", depends_on_step: Some(2), uses_entity_from: Some("email_password_combo") },
        ],
        estimated_cost: 400,
    ...
    AdvancedWorkflow {
        ...
        steps: &[
            ...
            WorkflowStep { step_num: 2, operation: "daily_email_scan", api: "OathNetPro", depends_on_step: Some(1), uses_entity_from: Some("employee_emails") },
