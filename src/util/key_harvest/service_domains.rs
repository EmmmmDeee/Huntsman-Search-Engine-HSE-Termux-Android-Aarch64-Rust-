...
pub(super) const API_SERVICE_DOMAINS: &[(&str, &str)] = &[
    ...
    // see-know.xyz/.eu/.icu hosts are retained too so a key leaked under an old
    // domain is still recognised as a SeekNow key.
    ...
    ("dashboard.see-know.xyz", "see_know"),
    ...
    ("dashboard.see-know.icu", "see_know"),
