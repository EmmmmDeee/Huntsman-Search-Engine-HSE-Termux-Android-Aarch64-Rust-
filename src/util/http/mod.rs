...
pub use fetch::{
    ...
    is_auth_failure_400_body, is_keyed_error_status, keyed_cascade, keyed_ok_or_404,
    note_keyed_error, parse_retry_after_secs, read_body_capped, read_text, retry_after_secs,
};
