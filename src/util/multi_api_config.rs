...
pub const CHAINING_RULES: &[ChainRule] = &[
    ...
    ChainRule {
        source_api: "SeekNow",
        entity_type_found: "domain",
        chain_to_api: "SecurityTrails",
        depth_increase: 1,
    },
    ChainRule {
        source_api: "SeekNow",
    ...
    ChainRule {
        source_api: "SeekNow",
        entity_type_found: "ip",
        chain_to_api: "AbuseIPDB",
        depth_increase: 1,
    },
    ChainRule {
        source_api: "SeekNow",
        entity_type_found: "email",
        chain_to_api: "Hunter.io",
        depth_increase: 1,
    },
    ...
    ChainRule {
        source_api: "Shodan",
        entity_type_found: "certificate",
        chain_to_api: "Censys",
        depth_increase: 1,
    },
    // SecurityTrails discoveries chain
    ChainRule {
        source_api: "SecurityTrails",
        entity_type_found: "ip",
        chain_to_api: "Shodan",
        depth_increase: 1,
    },
    ...
    ChainRule {
        source_api: "SecurityTrails",
        entity_type_found: "subdomain",
        chain_to_api: "Censys",
        depth_increase: 1,
    },
    // Hunter.io discoveries chain
    ChainRule {
        source_api: "Hunter.io",
        entity_type_found: "email",
        chain_to_api: "HIBP",
        depth_increase: 1,
    },
...
pub const COST_OPTIMIZATIONS: &[CostOptimization] = &[
    // Email operations
    CostOptimization {
        operation: "email_breach_check",
        recommended_api: "SeekNow",
        estimated_cost: 2,
        estimated_time_secs: 8,
    },
    CostOptimization {
        operation: "email_enumerate_company",
        recommended_api: "Hunter.io",
        estimated_cost: 1,
        estimated_time_secs: 3,
    },
    CostOptimization {
        operation: "email_password_breach",
        recommended_api: "HIBP",
        estimated_cost: 1,
        estimated_time_secs: 2,
    },
    CostOptimization {
        operation: "email_person_enrichment",
        recommended_api: "FullContact",
        estimated_cost: 1,
        estimated_time_secs: 2,
    },
    // Domain operations
    CostOptimization {
        operation: "domain_infrastructure",
        recommended_api: "Shodan",
        estimated_cost: 1,
        estimated_time_secs: 5,
    },
    CostOptimization {
        operation: "domain_dns_history",
        recommended_api: "SecurityTrails",
        estimated_cost: 1,
        estimated_time_secs: 3,
    },
    CostOptimization {
        operation: "domain_certificates",
        recommended_api: "Censys",
        estimated_cost: 1,
        estimated_time_secs: 5,
    },
    CostOptimization {
        operation: "domain_breach_check",
        recommended_api: "SeekNow",
        estimated_cost: 1,
        estimated_time_secs: 3,
    },
    ...
    CostOptimization {
        ...
        recommended_api: "AbuseIPDB",
        estimated_cost: 1,
        estimated_time_secs: 2,
    },
    CostOptimization {
        operation: "ip_threat_intel",
        recommended_api: "GreyNoise",
        estimated_cost: 1,
        estimated_time_secs: 3,
    },
    CostOptimization {
        operation: "ip_reverse_dns",
        recommended_api: "SecurityTrails",
        estimated_cost: 1,
        estimated_time_secs: 2,
    },
...
pub const API_RELIABILITY: &[ApiReliability] = &[
    ...
    ApiReliability {
        api: "SecurityTrails",
        sla_uptime_percent: 99.9,
        response_time_p95_ms: 2_000,
        error_rate_percent: 0.8,
    },
    ApiReliability {
        api: "Hunter.io",
        sla_uptime_percent: 99.9,
        response_time_p95_ms: 1_500,
        error_rate_percent: 0.5,
    },
    ApiReliability {
        api: "AbuseIPDB",
