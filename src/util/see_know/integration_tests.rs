...
//! documented endpoints, only 19 are ever actually invoked; `/stealer` was
...
//! (`/search/deep` is wired as a fast-miss fallback — see
//! `modules::see_know::Module::process`). [`ENDPOINTS`] now records the REAL
//! status of every
