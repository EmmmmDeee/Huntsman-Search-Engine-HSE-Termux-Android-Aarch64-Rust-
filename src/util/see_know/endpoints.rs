...
/// Live-dispatched since v1.19 as the typed-query-miss fallback from
/// `modules::see_know::mod` — see `docs/SEEKNOW_SETUP.md`'s endpoint coverage
/// table for current wiring status.
