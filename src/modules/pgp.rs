...
mod tests {
    ...
    fn split_uid_variants() {
        assert_eq!(
            split_uid("Matthew Diegmann <matt@example.com>"),
            (Some("Matthew Diegmann"), Some("matt@example.com"))
        );
        assert_eq!(
    ...
    fn extract_pulls_name_and_alternate_emails() {
        ...
        let body = "info:1:1\n\
            ...
            uid:Matthew%20Diegmann%20%3Cmatt%40example.com%3E:1500000000::\n\
            uid:Matthew%20Diegmann%20%3Cm.diegmann%40work.com%3E:1500000000::\n";
        ...
        assert!(has(EntityKind::Email, "m.diegmann@work.com"));
