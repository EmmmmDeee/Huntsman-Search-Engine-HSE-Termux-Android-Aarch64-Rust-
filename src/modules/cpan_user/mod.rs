...
impl Module for CpanUser {
    ...
    fn attack_techniques(&self) -> &'static [&'static str] {
        // Package-registry profile — T1593.003 for the Username itself, not
        ...
        // rubygems_user/gitlab_user). `build_entities` also constructs a
        // Person (real `name` field) and an Address/Coordinates
        ...
        // apply.
        &[
            "T1589.002", // Email Addresses — public emails + biography-extracted emails
            ...
            "T1593.003", // Code Repositories — Username via the MetaCPAN/PAUSE profile itself
        ]
    }
