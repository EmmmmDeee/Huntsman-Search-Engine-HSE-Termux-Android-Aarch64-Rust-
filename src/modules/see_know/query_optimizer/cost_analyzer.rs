...
impl CostAnalyzer {
    ...
    pub fn calculate_effective_cost(
        ...
        let reasoning = format!(
            "Credit: {:.1} + Latency: {:.2}*0.15 + Cascade: {:.1}*0.8 = {:.2} × Cache: {:.1} × Budget: {:.1} = {:.2} effective credits",
            credit_cost, latency_cost, cascade_mult, effective, cache_discount, budget_pressure, final_cost
        );
...
mod tests {
    ...
    fn test_budget_pressure() {
        ...
        // Plenty of budget
        let plenty = analyzer.calculate_effective_cost(
            "/search",
            1,
            None,
            5000,
        ...
        let low = analyzer.calculate_effective_cost(
            "/search",
            1,
            None,
            5000,
