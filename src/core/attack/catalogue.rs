//! MITRE ATT&CK reference data — the full Enterprise catalogue as pure static
//! triples. Split out of `attack/mod.rs` (behaviour-preserving) so the lookup /
//! coverage LOGIC there stays readable; this file is the ~4k-line DATA table the
//! rest of the module indexes into. Regenerated from the pinned STIX release
//! ([`super::ATTACK_VERSION`]); see the parent module doc for the framework-vs-
//! coverage invariant.
