...
pub use graph::{
    Adjacency, ConnectionTemplate, IdentityPath, PathStep, connection_templates, disjoint_pathways,
    identity_paths, is_identity_kind, reachable_count, undirected_adjacency,
};
