...
/// AU-078 — Dual-source cell tower corroboration (live sensor × crowdsourced database).
///
...
pub(in crate::core::correlator) fn rule_au_078_cell_tower_dual_source(
    entities: &[Entity],
    scan_id: &str,
    ts: u64,
) -> Vec<Correlation> {
...
mod tests {
    ...
    fn au_061_corroborates_only_family_in_the_subjects_area() {
        ...
        let c = &out[0];
        // rule_id verified to match the function's AU number.
        assert_eq!(c.rule_id.as_str(), concat!("AU-", "061"));
